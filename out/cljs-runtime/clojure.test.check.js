...
var vec__34774 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34774,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34774,(1),null);
...
var len__5897__auto___34921 = arguments.length;
var i__5898__auto___34924 = (0);
while(true){
if((i__5898__auto___34924 < len__5897__auto___34921)){
args__5903__auto__.push((arguments[i__5898__auto___34924]));

var G__34926 = (i__5898__auto___34924 + (1));
i__5898__auto___34924 = G__34926;
continue;
} else {
}
break;
...
return clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5904__auto__);
});

(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__34790){
var map__34793 = p__34790;
var map__34793__$1 = cljs.core.__destructure_map(map__34793);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34793__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34793__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34793__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__34799 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34799,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34799,(1),null);
...
var vec__34829 = size_seq__$1;
var seq__34830 = cljs.core.seq(vec__34829);
var first__34831 = cljs.core.first(seq__34830);
var seq__34830__$1 = cljs.core.next(seq__34830);
var size = first__34831;
var rest_size_seq = seq__34830__$1;
var vec__34832 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34832,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34832,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq34783){
...
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34784,G__34785,seq34783__$2);
}));
...
var map__34857 = smallest;
var map__34857__$1 = cljs.core.__destructure_map(map__34857);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34857__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__34945 = tail;
var G__34946 = current_smallest;
var G__34947 = (total_nodes_visited + (1));
var G__34948 = depth;
nodes = G__34945;
current_smallest = G__34946;
total_nodes_visited = G__34947;
depth = G__34948;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__34887_34953 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__34887_34953) : reporter_fn.call(null,G__34887_34953));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__34954 = children;
var G__34955 = new_smallest;
var G__34956 = (total_nodes_visited + (1));
var G__34957 = (depth + (1));
nodes = G__34954;
current_smallest = G__34955;
total_nodes_visited = G__34956;
depth = G__34957;
continue;
} else {
var G__34958 = tail;
var G__34959 = new_smallest;
var G__34960 = (total_nodes_visited + (1));
var G__34961 = depth;
nodes = G__34958;
current_smallest = G__34959;
total_nodes_visited = G__34960;
depth = G__34961;
continue;
}
}
...
var G__34898_34963 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__34898_34963) : reporter_fn.call(null,G__34898_34963));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__34892_SHARP_){
var G__34901 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__34892_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__34901) : reporter_fn.call(null,G__34901));
}));
var G__34905_34968 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__34905_34968) : reporter_fn.call(null,G__34905_34968));
