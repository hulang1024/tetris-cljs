...
var clojure$test$check$random$IRandom$rand_long$dyn_32837 = (function (rng){
var x__5519__auto__ = (((rng == null))?null:rng);
var m__5520__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
return (m__5520__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5520__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5520__auto__.call(null,rng));
} else {
var m__5518__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__5518__auto__ == null)))){
return (m__5518__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5518__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5518__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_long$dyn_32837(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_32838 = (function (rng){
var x__5519__auto__ = (((rng == null))?null:rng);
var m__5520__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
return (m__5520__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5520__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5520__auto__.call(null,rng));
} else {
var m__5518__auto__ = (clojure.test.check.random.rand_double["_"]);
if((!((m__5518__auto__ == null)))){
return (m__5518__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5518__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5518__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_double$dyn_32838(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_32840 = (function (rng){
var x__5519__auto__ = (((rng == null))?null:rng);
var m__5520__auto__ = (clojure.test.check.random.split[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
return (m__5520__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5520__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5520__auto__.call(null,rng));
} else {
var m__5518__auto__ = (clojure.test.check.random.split["_"]);
if((!((m__5518__auto__ == null)))){
return (m__5518__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5518__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5518__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$split$dyn_32840(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_32841 = (function (rng,n){
var x__5519__auto__ = (((rng == null))?null:rng);
var m__5520__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__5519__auto__)]);
if((!((m__5520__auto__ == null)))){
return (m__5520__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5520__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5520__auto__.call(null,rng,n));
} else {
var m__5518__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__5518__auto__ == null)))){
return (m__5518__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5518__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5518__auto__.call(null,rng,n));
} else {
...
return clojure$test$check$random$IRandom$split_n$dyn_32841(rng,n);
}
});
...
var G__32788 = z;
if(((24) > (function (){var G__32789 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__32789) : clojure.test.check.random.longs.bit_count.call(null,G__32789));
})())){
return clojure.test.check.random.longs.bit_xor(G__32788,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__32788;
}
});
...
var G__32843 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__32844 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__32843;
ret = G__32844;
continue;
}
...
(clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
}));
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__5162__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__32827){
var map__32828 = p__32827;
var map__32828__$1 = cljs.core.__destructure_map(map__32828);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32828__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__32829 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32829,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32829,(1),null);
