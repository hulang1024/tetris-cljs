...
return cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"break","break",126570225),(function (){var iter__5649__auto__ = (function malli$dev$pretty$_errors_$_iter__38016(s__38017){
return (new cljs.core.LazySeq(null,(function (){
var s__38017__$1 = s__38017;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38017__$1);
if(temp__5825__auto__){
var s__38017__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38017__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__38017__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__38019 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__38018 = (0);
while(true){
if((i__38018 < size__5648__auto__)){
var error = cljs.core._nth(c__5647__auto__,i__38018);
cljs.core.chunk_append(b__38019,malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer));

var G__38171 = (i__38018 + (1));
i__38018 = G__38171;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38019),malli$dev$pretty$_errors_$_iter__38016(cljs.core.chunk_rest(s__38017__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38019),null);
}
} else {
var error = cljs.core.first(s__38017__$2);
return cljs.core.cons(malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer),malli$dev$pretty$_errors_$_iter__38016(cljs.core.rest(s__38017__$2)));
}
} else {
return null;
}
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","explain","malli.core/explain",36932858),(function (_,p__38032,printer){
var map__38034 = p__38032;
var map__38034__$1 = cljs.core.__destructure_map(map__38034);
var explanation = map__38034__$1;
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38034__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","coercion","malli.core/coercion",698994541),(function (_,p__38037,printer){
var map__38038 = p__38037;
var map__38038__$1 = cljs.core.__destructure_map(map__38038);
var explain = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38038__$1,new cljs.core.Keyword(null,"explain","explain",484226146));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-input","malli.core/invalid-input",2010057279),(function (_,p__38040,printer){
var map__38041 = p__38040;
var map__38041__$1 = cljs.core.__destructure_map(map__38041);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38041__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38041__$1,new cljs.core.Keyword(null,"input","input",556931961));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38041__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-output","malli.core/invalid-output",-147363519),(function (_,p__38045,printer){
var map__38047 = p__38045;
var map__38047__$1 = cljs.core.__destructure_map(map__38047);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38047__$1,new cljs.core.Keyword(null,"value","value",305978217));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38047__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38047__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38047__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-guard","malli.core/invalid-guard",-946413611),(function (_,p__38053,printer){
var map__38054 = p__38053;
var map__38054__$1 = cljs.core.__destructure_map(map__38054);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38054__$1,new cljs.core.Keyword(null,"value","value",305978217));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38054__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38054__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38054__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-arity","malli.core/invalid-arity",577014581),(function (_,p__38056,printer){
var map__38059 = p__38056;
var map__38059__$1 = cljs.core.__destructure_map(map__38059);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38059__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38059__$1,new cljs.core.Keyword(null,"arity","arity",-1808556135));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38059__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38059__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","register-function-schema","malli.core/register-function-schema",-1224381998),(function (_,p__38062,printer){
var map__38063 = p__38062;
var map__38063__$1 = cljs.core.__destructure_map(map__38063);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var _data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"_data","_data",-1394265439));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var _exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38063__$1,new cljs.core.Keyword(null,"_exception","_exception",69029009));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-ref","malli.core/invalid-ref",-1109933109),(function (_,p__38064,printer){
var map__38065 = p__38064;
var map__38065__$1 = cljs.core.__destructure_map(map__38065);
var ref = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38065__$1,new cljs.core.Keyword(null,"ref","ref",1289896967));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-schema","malli.core/invalid-schema",1923990979),(function (_,p__38066,printer){
var map__38067 = p__38066;
var map__38067__$1 = cljs.core.__destructure_map(map__38067);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38067__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38067__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38072),malli$dev$pretty$iter__38069(cljs.core.chunk_rest(s__38070__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38072),null);
}
} else {
var proposal = cljs.core.first(s__38070__$2);
return cljs.core.cons(malli.dev.virhe._visit(proposal,printer),malli$dev$pretty$iter__38069(cljs.core.rest(s__38070__$2)));
}
} else {
return null;
}
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","child-error","malli.core/child-error",-473817473),(function (_,p__38089,printer){
var map__38090 = p__38089;
var map__38090__$1 = cljs.core.__destructure_map(map__38090);
var data = map__38090__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-entry","malli.core/invalid-entry",-1401097281),(function (_,p__38096,printer){
var map__38097 = p__38096;
var map__38097__$1 = cljs.core.__destructure_map(map__38097);
var entry = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38097__$1,new cljs.core.Keyword(null,"entry","entry",505168823));
...
var example = (function (){var G__38099 = wrapped;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(wrapped))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__38099,new cljs.core.Keyword(null,"any","any",1705907423));
} else {
return G__38099;
}
})();
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","duplicate-keys","malli.core/duplicate-keys",1684166326),(function (_,p__38105,printer){
var map__38107 = p__38105;
var map__38107__$1 = cljs.core.__destructure_map(map__38107);
var arr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38107__$1,new cljs.core.Keyword(null,"arr","arr",474961448));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.edn","var-parsing-not-supported","malli.edn/var-parsing-not-supported",-283037656),(function (_,p__38109,printer){
var map__38110 = p__38109;
var map__38110__$1 = cljs.core.__destructure_map(map__38110);
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38110__$1,new cljs.core.Keyword(null,"string","string",-1989541586));
var var$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38110__$1,new cljs.core.Keyword(null,"var","var",-769682797));
...
var _STAR_print_newline_STAR__orig_val__38132_38220 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38133_38221 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38134_38222 = true;
var _STAR_print_fn_STAR__temp_val__38135_38223 = (function (x__5817__auto__){
return sb__5816__auto__.append(x__5817__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38134_38222);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38135_38223);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38133_38221);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38132_38220);
}
...
var _STAR_print_newline_STAR__orig_val__38140_38226 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38141_38227 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38142_38228 = true;
var _STAR_print_fn_STAR__temp_val__38143_38229 = (function (x__5817__auto__){
return sb__5816__auto__.append(x__5817__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38142_38228);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38143_38229);

try{report(type,data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38141_38227);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38140_38226);
}
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5816__auto__));
})();
...
return (function() { 
var G__38235__delegate = function (args){
var temp__5825__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
if(cljs.core.truth_(temp__5825__auto__)){
var res = temp__5825__auto__;
var fexpr__38161_38236 = (actor.cljs$core$IFn$_invoke$arity$1 ? actor.cljs$core$IFn$_invoke$arity$1(printer) : actor.call(null,printer));
(fexpr__38161_38236.cljs$core$IFn$_invoke$arity$2 ? fexpr__38161_38236.cljs$core$IFn$_invoke$arity$2(type,res) : fexpr__38161_38236.call(null,type,res));
...
var G__38235 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38240__i = 0, G__38240__a = new Array(arguments.length -  0);
while (G__38240__i < G__38240__a.length) {G__38240__a[G__38240__i] = arguments[G__38240__i + 0]; ++G__38240__i;}
  args = new cljs.core.IndexedSeq(G__38240__a,0,null);
} 
return G__38235__delegate.call(this,args);};
G__38235.cljs$lang$maxFixedArity = 0;
G__38235.cljs$lang$applyTo = (function (arglist__38241){
var args = cljs.core.seq(arglist__38241);
return G__38235__delegate(args);
});
G__38235.cljs$core$IFn$_invoke$arity$variadic = G__38235__delegate;
return G__38235;
})()
;
});
