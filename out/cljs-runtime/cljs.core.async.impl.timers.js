...
var i_31643 = (self__.level + (1));
while(true){
if((i_31643 <= (new_level + (1)))){
(update[i_31643] = self__.header);

var G__31645 = (i_31643 + (1));
i_31643 = G__31645;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31650 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31650[i]));
} else {
x__$2.forward.push((((i < links_31650.length))?(links_31650[i]):null));
}

if((i < links_31650.length)){
(links_31650[i] = x__$2);
} else {
links_31650.push(x__$2);
}
...
var i_31671 = (0);
while(true){
if((i_31671 <= self__.level)){
var links_31673 = (update[i_31671]).forward;
if((x__$1 === (((i_31671 < links_31673.length))?(links_31673[i_31671]):null))){
(links_31673[i_31671] = (x__$1.forward[i_31671]));

var G__31677 = (i_31671 + (1));
i_31671 = G__31677;
continue;
} else {
var G__31678 = (i_31671 + (1));
i_31671 = G__31678;
continue;
}
} else {
...
var G__31689 = nx;
var G__31690 = (level__$1 - (1));
x = G__31689;
level__$1 = G__31690;
continue;
} else {
var G__31691 = x;
var G__31692 = (level__$1 - (1));
x = G__31691;
level__$1 = G__31692;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31706 = nx;
var G__31707 = (level__$1 - (1));
x = G__31706;
level__$1 = G__31707;
continue;
} else {
var G__31708 = x;
var G__31709 = (level__$1 - (1));
x = G__31708;
level__$1 = G__31709;
continue;
}
