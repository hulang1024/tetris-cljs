...
(clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"clojure.test.check.rose-tree/RoseTree");
}));
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__32880 = (n - (1));
var G__32881 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__32880,G__32881) : clojure.test.check.rose_tree.exclude_nth.call(null,G__32880,G__32881));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__32895 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__32895) : f.call(null,G__32895));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32889_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__32889_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__32889_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32896_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__32896_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__32896_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32897_SHARP_){
var G__32898 = clojure.test.check.rose_tree.root(p1__32897_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__32898) : pred.call(null,G__32898));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5649__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__32899(s__32900){
return (new cljs.core.LazySeq(null,(function (){
var s__32900__$1 = s__32900;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__32900__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__32909 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32909,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32909,(1),null);
var iterys__5645__auto__ = ((function (s__32900__$1,vec__32909,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__32899_$_iter__32901(s__32902){
return (new cljs.core.LazySeq(null,((function (s__32900__$1,vec__32909,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__32902__$1 = s__32902;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__32902__$1);
if(temp__5825__auto____$1){
var s__32902__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__32902__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__32902__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__32904 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__32903 = (0);
while(true){
if((i__32903 < size__5648__auto__)){
var child = cljs.core._nth(c__5647__auto__,i__32903);
cljs.core.chunk_append(b__32904,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__32955 = (i__32903 + (1));
i__32903 = G__32955;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32904),clojure$test$check$rose_tree$permutations_$_iter__32899_$_iter__32901(cljs.core.chunk_rest(s__32902__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32904),null);
}
} else {
var child = cljs.core.first(s__32902__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__32899_$_iter__32901(cljs.core.rest(s__32902__$2)));
}
} else {
return null;
}
...
});})(s__32900__$1,vec__32909,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__32900__$1,vec__32909,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5646__auto__ = cljs.core.seq(iterys__5645__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5646__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5646__auto__,clojure$test$check$rose_tree$permutations_$_iter__32899(cljs.core.rest(s__32900__$1)));
} else {
var G__32956 = cljs.core.rest(s__32900__$1);
s__32900__$1 = G__32956;
continue;
}
} else {
return null;
...
return iter__5649__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32925_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__32925_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__32925_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32933_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__32933_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__32933_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__32936 = f;
var G__32937 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__32936,G__32937) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__32936,G__32937));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__32939 = f;
var G__32940 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__32939,G__32940) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__32939,G__32940));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
